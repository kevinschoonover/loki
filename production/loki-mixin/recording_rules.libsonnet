  ...
  prometheusRules+:: {
    groups+: [{
      ...
      rules:
        ...
        utils.histogramRules('loki_request_duration_seconds', $._config.job_labels + ['job', 'route']) +
        utils.histogramRules('loki_request_duration_seconds', $._config.cluster_labels + ['job', 'route']),
    }],
  },
}
